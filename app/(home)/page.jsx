...
const projects = [
  {
  title:
    'موقع مطعم ديناميكي متكامل لعرض المنيو والطلبات أونلاين مع لوحة تحكم ذكية',
  link: 'umkhater.com',
  category: 'موقع ويب',
  description:
  ...
  image:
    'https://github.com/hanynan8/e-commerce/blob/main/%D8%B3.png?raw=true',
  tech: ['Tailwind', 'Node.js', 'MongoDB', 'Next.js'],
},
{
  title:
    'منصة تعليمية ديناميكية متكاملة بنظام تسجيل دخول ولوحة تحكم لإدارة المحتوى',
  ...
  image:
    'https://github.com/hanynan8/e-commerce/blob/main/Screenshot%20(1912).png?raw=true',
  tech: ['Tailwind', 'Node.js', 'MongoDB', 'Next.js'],
},
{
  title:
    'متجر ملابس إلكتروني ديناميكي مع نظام إدارة منتجات ولوحة تحكم احترافية',
  link: 'https://accessoir.vercel.app/',
  category: 'موقع ويب',
  description:
  ...
  image:
    'https://github.com/hanynan8/e-commerce/blob/main/Screenshot%20(1911).png?raw=true',
  tech: ['Tailwind', 'Node.js', 'MongoDB', 'Next.js'],
},
  {
    title:
